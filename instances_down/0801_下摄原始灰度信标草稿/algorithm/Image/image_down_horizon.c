...
#ifdef IMAGE_DOWN_HORIZON_TEST_HOOKS
static uint8 s_force_full_scan;
#endif
                                       ...
                                       float cone_cos)
{
    ...
    {
#ifdef IMAGE_DOWN_HORIZON_TEST_HOOKS
        if (s_force_full_scan == 0U &&
            down_horizon_track_column(x, gravity_camera, cone_cos) != 0U)
#else
...
#ifdef IMAGE_DOWN_HORIZON_TEST_HOOKS
void image_down_horizon_test_force_full_scan(uint8 force)
{
    s_force_full_scan = (force != 0U) ? 1U : 0U;
}
#endif
