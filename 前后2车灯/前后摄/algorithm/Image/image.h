...
{
    uint32 latch_us;
    uint32 scene_mean_us;
    uint32 lamp_threshold_us;
    uint32 lamp_primary_us;
    uint32 lamp_gray_us;
    uint32 lamp_temporal_us;
    uint32 beacon_box_us;
    uint32 beacon_peak_us;
    uint32 beacon_component_us;
    uint32 beacon_store_us;
    uint32 post_us;
    uint32 stage_sum_us;
} image_profile_data_t;
...
extern image_profile_data_t g_image_profile;
