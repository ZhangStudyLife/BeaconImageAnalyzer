...
static unsigned int gray_integral_box_sum_pair(int x, int y, int radius)
{
    int left = x + GRAY_BEACON_BOX_PAD - radius;
    int right = x + GRAY_BEACON_BOX_PAD + radius + 1;
    int top = y + GRAY_BEACON_BOX_PAD - radius;
    ...
    unsigned int bottom_right =
        gray_integral_load_pair(&g_gray_integral[bottom][right]);
    unsigned int top_right =
        gray_integral_load_pair(&g_gray_integral[top][right]);
    unsigned int bottom_left =
        gray_integral_load_pair(&g_gray_integral[bottom][left]);
    unsigned int top_left =
        gray_integral_load_pair(&g_gray_integral[top][left]);
...
static void gray_cache_integral_response_pair(int x, int y)
{
    ...
    unsigned int box3 = gray_integral_box_sum_pair((int)pair_x, y, 1);
    unsigned int box9 = gray_integral_box_sum_pair((int)pair_x, y, 4);
