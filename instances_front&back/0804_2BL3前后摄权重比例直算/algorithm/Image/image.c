    ...
    unsigned char point_source_mode)
{
    ...
    weight_denominator = (float)weight_sum_twice;
    centroid_x = (float)weight_x_twice / weight_denominator;
    centroid_y = (float)weight_y_twice / weight_denominator;
    covariance_xx = (float)weight_xx_twice / weight_denominator -
                    centroid_x * centroid_x;
    covariance_yy = (float)weight_yy_twice / weight_denominator -
                    centroid_y * centroid_y;
    covariance_xy = (float)weight_xy_twice / weight_denominator -
    ...
    features->concentration =
        (float)inner_weight_twice / weight_denominator;
