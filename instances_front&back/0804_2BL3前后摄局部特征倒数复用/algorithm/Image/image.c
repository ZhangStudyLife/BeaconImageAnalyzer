    ...
    gray_beacon_features_t *features)
{
    ...
    inverse_weight_sum = 1.0f / weight_sum;
    centroid_x = weight_x * inverse_weight_sum;
    centroid_y = weight_y * inverse_weight_sum;
    covariance_xx = weight_xx * inverse_weight_sum -
                    centroid_x * centroid_x;
    covariance_yy = weight_yy * inverse_weight_sum -
                    centroid_y * centroid_y;
    covariance_xy = weight_xy * inverse_weight_sum -
    ...
    features->concentration = inner_weight * inverse_weight_sum;
